...
do {
    ...
    isa_ok $doc, 'Language::SX::Document', 'simple strings result';
    is $doc->node_count, 4, 'correct amount of strings';

    isa_ok $doc->get_node($_), 'Language::SX::Document::String::Constant', "item $_ is a constant string"
        for 0 .. 3;
...
do {
    ...
    isa_ok $doc, 'Language::SX::Document', 'interpolated string result';
    is $doc->node_count, 1, 'correct amount of strings';

    my $str = $doc->get_node(0);
    isa_ok $str, 'Language::SX::Document::String';
    is $str->string_part_count, 3, 'correct amount of string parts';

    my ($foo, $bar, $baz) = $str->all_string_parts;
    isa_ok $foo, 'Language::SX::Document::String::Constant', 'starting string part';
    is ref($bar), 'ARRAY', 'interpolated value represented by list';
    is scalar(@$bar), 1, 'list contains one value';
    isa_ok $bar->[0], 'Language::SX::Document::Bareword', 'list contains a bareword';
    isa_ok $baz, 'Language::SX::Document::String::Constant', 'ending string part';
...
do {
    ...
    isa_ok $doc, 'Language::SX::Document', 'tight interpolated string result';
    is $doc->node_count, 1, 'correct amount of strings';
...
do {
    ...
    isa_ok $doc, 'Language::SX::Document', 'nested string result';
    is $doc->node_count, 3, 'correct amount of strings';

    my ($before, $str, $after) = $doc->all_nodes;

    isa_ok $before, 'Language::SX::Document::Bareword';
    isa_ok $after, 'Language::SX::Document::Bareword';
    ...
    isa_ok $foo, 'Language::SX::Document::String::Constant';
    isa_ok $bar, 'Language::SX::Document::String::Constant';
    ...
    isa_ok $num, 'Language::SX::Document::Number';
    isa_ok $apply, 'Language::SX::Document::Cell::Application';
    is $apply->node_count, 5, 'correct number of nodes in application';
    
    my ($join, $sep, $x, $y, $z) = $apply->all_nodes;

    isa_ok $join, 'Language::SX::Document::Bareword';
    isa_ok $sep, 'Language::SX::Document::String::Constant';
    isa_ok $x, 'Language::SX::Document::Bareword';
    isa_ok $y, 'Language::SX::Document::Bareword';
    isa_ok $z, 'Language::SX::Document::Bareword';
...
do {
    ...
    isa_ok $doc->get_node(0), 'Language::SX::Document::String::Constant';
