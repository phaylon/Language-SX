...
The first item is a L<bareword|Template::SX::Runtime::Bareword>. Next there can be an
...
Template::SX::Renderer::TagBased - Render tag-based markup out of a simple tree structure
...
Returns the meta object for C<Template::SX::Renderer::TagBased> as an instance of L<Moose::Meta::Role>.
