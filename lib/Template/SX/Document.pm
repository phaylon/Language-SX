...
#        return $self->loaded_callback->($persist ? $vars : (%$vars));
    ...
    method new_node_from_stream (Template::SX::Reader::Stream $stream, Token $token) {
...
Template::SX::Document - A L<Temülate::SX> document object.
...
=item * L<Token|Template::SX::Types/Token> C<$token>
...
Returns the meta object for C<Template::SX::Document> as an instance of L<Class::MOP::Class::Immutable::Moose::Meta::Class>.
...
L<Scope|Template::SX::Types/Scope>
