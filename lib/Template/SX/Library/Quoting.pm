...
@class Template::SX::Library::Quoting
...
The class L<Template::SX::Document::Quote> is handling the transformation of the
...
stringified) and the value will be an L<Template::SX::Runtime::Bareword>.
...
Template::SX::Library::Quoting - All functionality related to quoting
...
Returns the meta object for C<Template::SX::Library::Quoting> as an instance of L<Moose::Meta::Class>.
