...
@synopsis
    ...
    class MyLibrary extends Template::SX::Library::Group {
        use MooseX::ClassAttribute;
...
Template::SX::Library::Group - Library group base functionality
...
Returns the meta object for C<Template::SX::Library::Group> as an instance of L<Moose::Meta::Class>.
