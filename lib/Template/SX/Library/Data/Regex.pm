...
@class Template::SX::Library::Data::Regex
...
Regular expressions in L<Template::SX> are in the following format:
...
Template::SX::Library::Data::Regex - All regular expression functionality
...
Returns the meta object for C<Template::SX::Library::Data::Regex> as an instance of L<Moose::Meta::Class>.
