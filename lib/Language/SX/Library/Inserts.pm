...
class Language::SX::Library::Inserts extends Language::SX::Library {
    ...
    method _build_inserter (ClassName $class: Str $name, Str $maker, Int $max_args?) {
        ...
        return sub {
            ...
            @args = map {
                ...
                $_->isa('Language::SX::Document::Bareword')     ? pp([bare  => $_->value])
              : $_->isa('Language::SX::Document::Keyword')      ? pp([group => $_->value])
              : E_SYNTAX->throw(
...
@see_also Language::SX/Modules
@license  Language::SX

@class Language::SX::Library::Inserts
...
L<Language::SX/include_path>.

The C<document-arguments> are passed to the document specified in C<file> as if that
document was L<run|Language::SX/run> with those arguments. The arguments are mandatory.
...
Language::SX::Library::Inserts - Functionality to re-use other documents
...
Returns the meta object for C<Language::SX::Library::Inserts> as an instance of L<Moose::Meta::Class>.
