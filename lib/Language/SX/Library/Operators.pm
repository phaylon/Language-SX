...
class Language::SX::Library::Operators extends Language::SX::Library {
...
@class Language::SX::Library::Operators
...
like L<Language::SX::Library::ScopeHandling/lambda> does. This is especially useful
...
Language::SX::Library::Operators - All functionality concerning operators
...
Returns the meta object for C<Language::SX::Library::Operators> as an instance of L<Moose::Meta::Class>.
