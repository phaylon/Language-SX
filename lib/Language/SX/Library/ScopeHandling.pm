...
class Language::SX::Library::ScopeHandling extends Language::SX::Library {
    ...
    CLASS->add_syntax('apply!', sub {
        ...
        if ($target->isa('Language::SX::Document::Cell::Application')) {
        ...
        my $apply = Language::SX::Document::Cell::Application->new(
...
#                    warn "GETTING $arg = $vs_args{ $arg } " . pp(\%vs_args); 
    ...
    multi method _compile_setter (Object $inf, Object $cell, Language::SX::Document::Bareword $var, Object $source) {
    ...
    multi method _compile_setter (Object $inf, Object $cell, Language::SX::Document::Cell::Application $special, Object $source) {
        ...
        ) unless $setter->isa('Language::SX::Document::Bareword');
...
#                warn "RES";
    ...
    method _unpack_let (Str $name, Object $inf, Object $cell, ArrayRef[Object] $args, Bool :$forbid_redefine) {
        ...
        ) unless $vars->isa('Language::SX::Document::Cell::Application');
        ...
        return(
            [ map {
                ...
                ) unless $pair->isa('Language::SX::Document::Cell::Application');
    ...
    CLASS->add_syntax(define => sub {
        ...
        if ($target) {
            ...
            if ($target->isa('Language::SX::Document::Bareword')) {
            ...
            elsif ($target->isa('Language::SX::Document::Cell::Application')) {
    ...
    method _compile_value_definition (Object $inf, Object $cell, Language::SX::Document::Bareword $variable, Object $source) {
...
#        $inf->collect_lexical($variable->value);
    ...
    method _compile_empty_definition (Object $inf, Object $cell, Language::SX::Document::Bareword $variable) {
...
#        $inf->collect_lexical($variable->value);
    ...
    method _compile_lambda_definition (Object $inf, Object $cell, Language::SX::Document::Cell::Application $sig, @body) {
...
#        $inf->collect_lexical($name->value);
    ...
    method _wrap_lambda (Object $inf, Object $cell, Object $sig, ArrayRef[Object] $body) {
        ...
        require Language::SX::Library::ScopeHandling::Lambda;
        my $lambda = Language::SX::Library::ScopeHandling::Lambda->new(
        ...
        if ($name->isa('Language::SX::Document::Cell::Application')) {
...
#            return $self->_wrap_lambda($inf, $cell, $name, $wrapped_body);
        ...
        elsif ($name->isa('Language::SX::Document::Bareword')) {
...
#            return ($name->value, $self->_render_lambda_from_signature($inf, $param_sig, $body));
    ...
    method _render_definition (Object $inf, Object $cell, Language::SX::Document::Bareword $name, Str $source) {
...
#                my $new_env = { vars => \%vars, parent => $env };
    ...
    method deparse_signature (Language::SX::Inflator $inf, Object $signature) {
        
        if ($signature->isa('Language::SX::Document::Bareword')) {
        ...
        elsif ($signature->isa('Language::SX::Document::Cell::Application')) {
...
#                ) unless $node->isa('Language::SX::Document::Bareword');
                ...
                if ($node->isa('Language::SX::Document::Bareword') and $node->is_dot) {
...
#                    $inf->assure_unreserved_identifier($node);
            ...
            PARAM: while (my $param = shift @nodes) {
                ...
                if ($param->isa('Language::SX::Document::Bareword') and $param->value eq '.') {
...
@see_also Language::SX::Library::Data::Functions
@license  Language::SX

@class Language::SX::Library::ScopeHandling
...
If you imported types via L<Language::SX::Library::Types/"import/types">, you can use them
in your signatures:
...
A simple example using the L<list-ref|Language::SX::Library::Data::Lists/list-ref> setter 
would be:

    (define foo '(1 2 3))
    (set! (list-ref foo 1) 5)

There are also setters for L<list-splice|Language::SX::Library::Data::Lists/list-splice>,
L<hash-ref|Language::SX::Library::Data::Hashes/hash-ref>,
L<hash-splice|Language::SX::Library::Data::Hashes/hash-splice> and
L<values|Language::SX::Library::Data::Common/values>.
...
This is a mixture construct of L</set!> and L<Language::SX::Library::Data::Functions/apply>.
...
of L<Language::SX>. The above is equivalent to
...
=item * L<Location|Language::SX::Types/Location> C<:$set_location>
...
Returns the meta object for C<Language::SX::Library::ScopeHandling> as an instance of L<Moose::Meta::Class>.
