...
class Language::SX::Library::Types extends Language::SX::Library {
    ...
    CLASS->add_syntax('import/types', sub {
        ...
        my @spec = map {
            ...
            if ($import->isa('Language::SX::Document::Cell::Application')) {
                ...
                ) unless $lib->isa('Language::SX::Document::Bareword');
                ...
                $res = [
                    ...
                    map {
                        ...
                        ) unless $type->isa('Language::SX::Document::Bareword');

                        [$type->value, $type->location];
                    } @types
                ];
            }
            elsif ($import->isa('Language::SX::Document::Bareword')) {
                ...
                E_SYNTAX->throw(
                    ...
                    location    => $import->location,
                ) unless $import->isa('Language::SX::Document::Cell::Application');
            }
...
@class Language::SX::Library::Types
Type functionality
...
At least when used in L<Language::SX>, type constraints are not regarded as objects. An invocation of a type
...
If you really need to invoke the type constraints object methods, use L<Language::SX::Library::Data::Objects/object-invocant>:
...
It is currently not yet possible to declare coercions withing L<Language::SX>.
...
Language::SX::Library::Types - Type functionality
...
Returns the meta object for C<Language::SX::Library::Types> as an instance of L<Moose::Meta::Class>.
