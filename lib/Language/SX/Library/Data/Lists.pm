...
class Language::SX::Library::Data::Lists extends Language::SX::Library {
...
@see_also Language::SX::Data
@see_also Language::SX::Library::ScopeHandling
@license  Language::SX

@class Language::SX::Library::Data::Lists
...
Since L<Language::SX> does not have a syntax even close to Perl (5 or 6), a C<gather/take>
...
should return C<-1>, C<0> or C<1>. See L<Language::SX::Library::Data::Strings/cmp> for alphabetic
sorting and L<Language::SX::Library::Data::Numbers/"E<lt>=E<gt>"> for numeric sorting.
...
Language::SX::Library::Data::Lists - All functionality concerning lists
...
Returns the meta object for C<Language::SX::Library::Data::Lists> as an instance of L<Moose::Meta::Class>.
