...
class Language::SX::Library::Data::Objects extends Language::SX::Library {
...
@class Language::SX::Library::Data::Objects
...
methods on L<types|Language::SX::Library::Types>, since they are special handled.
...
Since L<Language::SX> does not allow strings to be used as applicants, this is 
...
Language::SX::Library::Data::Objects - All functionality related to objects
...
Returns the meta object for C<Language::SX::Library::Data::Objects> as an instance of L<Moose::Meta::Class>.
