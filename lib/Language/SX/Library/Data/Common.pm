...
class Language::SX::Library::Data::Common extends Language::SX::Library {
...
@class Language::SX::Library::Data::Common
...
See L</at> for an explanation on the differences in Perl's and Language::SX's
...
There are a couple of differences between how L<Language::SX> and Perl handle deep
...
Language::SX::Library::Data::Common - Common data functionality
...
Returns the meta object for C<Language::SX::Library::Data::Common> as an instance of L<Moose::Meta::Class>.
