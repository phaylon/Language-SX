...
class Language::SX::Library::Data::Functions extends Language::SX::Library {
...
@class Language::SX::Library::Data::Functions
...
in L<Language::SX> only takes function and applicant arguments. The arguments are, in order:
...
L<Language::SX::Library::Data::Strings/cmp> by saying:
...
Language::SX::Library::Data::Functions - This library contains all functionality regarded to functions and application.
...
Returns the meta object for C<Language::SX::Library::Data::Functions> as an instance of L<Moose::Meta::Class>.
