...
class Language::SX::Library::Branching extends Language::SX::Library {
    ...
    method _compile_cond_clause (Object $inf, Object $clause) {
        ...
        ) unless $clause->isa('Language::SX::Document::Cell::Application');
        ...
        if ($clause->node_count == 2) {
            ...
            ) unless $op->isa('Language::SX::Document::Bareword');
            ...
            if ($op->value eq '=>') {
                ...
                require Language::SX::Inflator::Precompiled;
                $conseq = Language::SX::Inflator::Precompiled->new(
                    location    => $op->location,
...
@class Language::SX::Library::Branching
...
is called. If it does, it will pass the found value to L<Language::SX::Library::Lists/append>
...
Language::SX::Library::Branching - Branching and conditional functionality
...
Returns the meta object for C<Language::SX::Library::Branching> as an instance of L<Moose::Meta::Class>.
