...
class Language::SX::REPL {
    ...
    method _build_sx { Language::SX->new }
...
@class Language::SX::REPL
Reads, evaluates and prints L<Language::SX> expressions in a loop
...
@attr sx
The L<Language::SX> instance evaluating the expressions.

@DESCRIPTION
This module contains functionality for a L<Language::SX> REPL. A command-line interpreter
to play around in.
...
Language::SX::REPL - Reads, evaluates and prints L<Language::SX> expressions in a loop
...
Returns the meta object for C<Language::SX::REPL> as an instance of L<Class::MOP::Class::Immutable::Moose::Meta::Class>.
