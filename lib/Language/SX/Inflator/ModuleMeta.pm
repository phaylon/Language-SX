...
class Language::SX::Inflator::ModuleMeta {
    ...
    method new_from_tree (ClassName $class: ArrayRef[Object] :$arguments!) {
        ...
        for my $node (@$arguments) {
            ...
            ) unless $node->isa('Language::SX::Document::Cell::Application') and $node->node_count;
    ...
    method _parse_exports (ClassName $class: ArrayRef[Object] :$elements) {
        ...
        for my $node (@$elements) {
            ...
            if ($node->isa('Language::SX::Document::Bareword')) {

                push @exports, $node->value;
            }
            elsif ($node->isa('Language::SX::Document::Cell::Application')) {
                ...
                ) unless $name->isa('Language::SX::Document::Keyword');

                $_->isa('Language::SX::Document::Bareword')
                    or E_SYNTAX->throw(
    ...
    method _parse_requires (ClassName $class: ArrayRef[Object] :$elements) {
        ...
        for my $library (@$elements) {
            ...
            ) unless $library->isa('Language::SX::Document::Bareword')
                  or $library->isa('Language::SX::Document::String::Constant');
    ...
    method _compile_arguments (Object $inf) {
        ...
        return '$Language::SX::MODULE_META->{arguments} = ' . pp($self->arguments);
    }
    ...
    method _compile_exports (Object $inf) {
        ...
        return '$Language::SX::MODULE_META->{exports} = ' . pp($self->exports);
    }
...
Language::SX::Inflator::ModuleMeta - Contain and render module meta information.
...
Language::SX::Inflator::ModuleMeta
...
Returns the meta object for C<Language::SX::Inflator::ModuleMeta> as an instance of L<Class::MOP::Class::Immutable::Moose::Meta::Class>.
