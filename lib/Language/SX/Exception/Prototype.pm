...
class Language::SX::Exception::Prototype is dirty {
...
@see_also Language::SX::Exception
@license  Language::SX

@class Language::SX::Exception::Prototype
...
@description
This is not a usual L<Language::SX::Exception>. It is a location-less prototype
exception that can be thrown, but gives internal parts of L<Language::SX> the
...
Language::SX::Exception::Prototype - Exception prototypes without locations
...
Language::SX::Exception::Prototype
...
Returns the meta object for C<Language::SX::Exception::Prototype> as an instance of L<Class::MOP::Class::Immutable::Moose::Meta::Class>.
