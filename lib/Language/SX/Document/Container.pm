...
class Language::SX::Document::Container {
    ...
    method compile_nodes (Language::SX::Inflator $inf, Scope $scope, Str $separator) {
...
@see_also Language::SX::Document::Cell
@license  Language::SX
...
functionality. This includes L<Language::SX::Document> itself.
...
Language::SX::Document::Container - Document item container base class
...
Language::SX::Document::Container
...
Returns the meta object for C<Language::SX::Document::Container> as an instance of L<Class::MOP::Class::Immutable::Moose::Meta::Class>.
...
=item * L<Language::SX::Document::Cell>
