...
class Language::SX::Exception is dirty {
    ...
    method format_message () {
        ...
        (my $type = ref $self) =~ s/^Language::SX:://;
...
Language::SX::Exception - Exception base class
...
Returns the meta object for C<Language::SX::Exception> as an instance of L<Class::MOP::Class::Immutable::Moose::Meta::Class>.
